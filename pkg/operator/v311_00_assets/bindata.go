...
// sources:
// bindata/v3.11.0/openshift-controller-manager/cluster-policy-controller-leader-role.yaml
// bindata/v3.11.0/openshift-controller-manager/cluster-policy-controller-leader-rolebinding.yaml
...
var _v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRoleYaml = []byte(`# This role is necessary to create leader lock configmap for upgrades 4.2-> 4.3
...
func v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRoleYamlBytes() ([]byte, error) {
	return _v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRoleYaml, nil
}

func v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRoleYaml() (*asset, error) {
	bytes, err := v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRoleYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/openshift-controller-manager/cluster-policy-controller-leader-role.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRolebindingYaml = []byte(`# This rolebinding binds role for creation of leader lock configmap for upgrades 4.2-> 4.3
# cluster-policy-controller is split from openshift-controller-manager in 4.3
# leader lock in openshift-controller-manager NamespaceSecurityAllocationController and in ClusterPolicyController
# cluster-policy-controller container runs in ns openshift-kube-controller-manager static pod
...
func v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRolebindingYamlBytes() ([]byte, error) {
	return _v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRolebindingYaml, nil
}

func v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRolebindingYaml() (*asset, error) {
	bytes, err := v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRolebindingYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "v3.11.0/openshift-controller-manager/cluster-policy-controller-leader-rolebinding.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"v3.11.0/openshift-controller-manager/cluster-policy-controller-leader-role.yaml":        v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRoleYaml,
	"v3.11.0/openshift-controller-manager/cluster-policy-controller-leader-rolebinding.yaml": v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRolebindingYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"v3.11.0": {nil, map[string]*bintree{
		"openshift-controller-manager": {nil, map[string]*bintree{
			"cluster-policy-controller-leader-role.yaml":        {v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRoleYaml, map[string]*bintree{}},
			"cluster-policy-controller-leader-rolebinding.yaml": {v3110OpenshiftControllerManagerClusterPolicyControllerLeaderRolebindingYaml, map[string]*bintree{}},
